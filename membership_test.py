...
def getMF ():
    ...
    input_feature_low = [
            [0.3546, 0.5631, 1.6666, 0.8757],
            [1.2477, 1.8233, 2.1866, 0.4567],
            [2.0877, 2.6188, 3.5922, 0.6676]
        ],[
            [0.4440, 0.6028, 0.7529, 0.5668],
            [0.7529, 0.8677, 0.9250, 0.4332]
        ],[
            [0.0035, 0.0164, 0.2764, 0.7882],
            [0.1103, 0.3462, 0.6416, 0.7153],
            [0.5542, 0.7592, 0.7795, 0.4965]
        ],[
            [0.00015209, 0.0010, 0.0362, 0.8520],
            [0.0132, 0.0423, 0.0811, 0.7062],
            [0.0730, 0.0973, 0.0985, 0.4419]
        ]
    n_rule = []
